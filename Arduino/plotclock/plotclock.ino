...
{ 
  ...
  //Сервогорны будут иметь угол между движениями 90°, параллельно осям x и y.
  drawTo(-3, 29.2);
  delay(5000);
  drawTo(74.1, 28);
  delay(5000);
...
time_minute = random(0,99);
time_hour = random(0,99);
/*
  time_minute++;
  if (time_minute>59) {
    time_minute=0;
